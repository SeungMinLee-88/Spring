...
public class ApplyContentDto {
	...
	public ApplyContentDto(int APPLY_NUM, String MEMBER_NAME, String MEMBER_DEPTCODE
			...
			,Date MEMBER_APPLY_NUM, String APPLY_STATUS) {
		...
		this.MEMBER_APPLY_NUM = MEMBER_APPLY_NUM;
	...
	public Date getMEMBER_APPLY_NUM() {
		return MEMBER_APPLY_NUM;
	}

	public void setMEMBER_APPLY_NUM(Date mEMBER_APPLY_NUM) {
		MEMBER_APPLY_NUM = mEMBER_APPLY_NUM;
	}
