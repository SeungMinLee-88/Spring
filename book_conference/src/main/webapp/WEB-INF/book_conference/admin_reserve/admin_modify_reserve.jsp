...
<%@ page import="com.book_conference.adminreserve.dto.RoomDto"%>
...
<body>
<div id="admin_form"><body>
<iframe name="frame"  width="1200px" height="780px"  src="./RoomBookModifyCalendar?roomnum=<%=roomnum %>&month=<%=month%>&bookdate=<%=bookdate%>" scrolling="auto" frameborder="0">
</iframe>
<form name="bookform" action="./ModifyBookProcess" method="post" onsubmit="return reservecheck()">
...
<td colspan="2">
<b>
<input type="text" name="BOOK_MEMBER" 
style="width:100%; border: 0;font-weight: bold" value="<%=Dto.getBOOK_MEMBER()%>"
onclick="javascript:openUserList()" readonly>
</b>
</td>
</tr>
<tr>
...
<input type="image" src="./image/formimage/ok.png" value="submit" width="50px">
<a href="./AdminReserveList?month=<%=month%>&amp;roomnum=<%=roomnum%>&page=<%=pagenum%>"><img src="./image/formimage/cancel.png" width="50px"></a>
</td>
</tr>
</table>
</form>
